...
mongoose.connection.on('error', function() {
  console.info('Error: Could not connect to MongoDB. Did you forget to run `mongod`? You asshole');
});
 ...
 * ==> Very verbose and could definitely be improved with async.each or promises
 */
...
server.listen(app.get('port'), function(){
  console.log('SAHAT-NEF server listening on port ' + app.get('port'));
})